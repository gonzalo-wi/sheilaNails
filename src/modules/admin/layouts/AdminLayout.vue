...
const menuItems = [
  ...
  { name: 'Servicios', icon: Scissors, route: '/admin/servicios' },
...
<template>
  <div class="min-h-screen bg-neutral-50 flex">
    ...
    <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-neutral-900 text-white">
      <div class="flex items-center h-16 px-6 border-b border-neutral-800">
        <h1 class="text-xl font-display font-bold">Nails Studio</h1>
      </div>
      ...
      <div class="p-4 border-t border-neutral-800">
        <div class="flex items-center gap-3 px-4 py-3 mb-2 bg-neutral-800 rounded-lg">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm font-medium truncate">{{ authStore.userFullName }}</p>
        ...
        <div class="h-16 px-4 lg:px-8 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <div class="text-right hidden sm:block">
              <p class="text-sm font-medium text-neutral-900">{{ authStore.userFullName }}</p>
              <p class="text-xs text-neutral-600">{{ authStore.user?.rol }}</p>
            </div>
